...
const RestaurantCard = (props) => {
  ...
  const [image, setImage] = useState({
    images: [
        {
            location: "https://b.zmtcdn.com/data/pictures/chains/1/50471/6fa39637442e85efb64a5c0db7b31b7f_o2_featured_v2.jpg"
        }
    ]
  });
  
    return <Link to={`/restaurant/${props._id}/overview`} 
            ...
            <div className='w-full relative'>
                ...
                <div className='my-2 flex flex-col gap-2'>
                    <div className='flex items-center justify-between'>
                        ...
                        <span className='bg-green-800 text-white text-sm gap-3 p-1 rounded flex items-center'>
