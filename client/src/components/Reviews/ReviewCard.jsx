    ...
    <div className='my-3 flex flex-col gap-3 pb-4 border-b border-gray-300'>
      <div className='flex items-center justify-between'>
        <div className='flex items-center gap-2'>
          <div className='w-10 h-10 rounded-full'>
            <img src='https://static.vecteezy.com/system/resources/thumbnails/002/002/403/small/man-with-beard-avatar-character-isolated-icon-free-vector.jpg' alt='avatar' className='w-full h-full rounded-full object-cover'/>
          </div>
      ...
      <div className='flex flex-col gap-3'>
        ...
        <div className='w-full'>
          <p classsName='w-full text-gray-600 font-light text-base'>
            {props.reviewText}
          </p>
        </div>
      </div>
