...
const RestaurantInfo = (props) => {
  ...
  <div className='flex flex-col-reverse md:flex-row md:items-center justify-between gap-3'>
    ...
    <div className='flex items-center gap-6 text-ms md:text-base'>
      <div className='flex items-center gsp-2'>
        ...
        <span>
          <strong>100</strong>
          <p className='border-dashed border-b border-black border-gray-500'>
            Dining Reviews
            </p>
        </span>
      </div>
  ...
  <div className='text-base md:text-lg text-gray-600 flex flex-col gap-2 md:block'>
        ...
        <div className='text-sm'>
          <span className='text-yellow-500'>Open Now</span> -11am - 8pm (Today)
        </div>
      </div>
    </>
  )
